            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        @if (session('success'))
                        <div id="success-message" class="mb-6 p-4 bg-green-50 border-l-4 border-green-500">
                            <div class="flex">
                    ...
                    @endif
                        <div class="flex justify-between items-center mb-6">
                            <h3 class="text-lg font-medium text-gray-900">{{ __('instructors.manage_instructors') }}
                            </h3>
                                        ...
                                        <tr>
                                                ...
                                                <div class="flex items-center justify-center gap-2">
                                                    <div class="flex-shrink-0 h-10 w-10">
                                                        <img class="h-10 w-10 rounded-full"
                                                            src="{{ $instructor->user->avatar ? asset($instructor->user->avatar) : 'https://ui-avatars.com/api/?name=' . urlencode($instructor->user->first_name . ' ' . $instructor->user->last_name) . '&color=7F9CF5&background=EBF4FF' }}"
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <div class="flex justify-end space-x-2">
                                                    <a href="{{ route('web.instructors.show', $instructor) }}"
                                                        class="text-[#066B87] hover:text-[#055a72]">
                                                    ...
                                                    <form action="{{ route('web.instructors.destroy', $instructor) }}"
                                        ...
                                        <tr>
                                            <td colspan="4" class="px-6 py-8 text-center">
                                                <div class="text-gray-500">
                                                    ...
                                                    <p class="mt-2 text-sm font-medium">{{ __('common.not_found') }}
                                                    </p>
                                                    <p class="mt-1 text-xs text-gray-500">{{ __('common.create_new') }}
                                                    </p>
                                                    <div class="mt-4">
                                                        <a href="{{ route('web.instructors.create') }}"
