    ...
    <form method="POST" action="{{ isset($course) ? route('courses.update', $course) : route('courses.store') }}"
        ...
        <div x-show="currentStep === 1" x-transition>
            <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-3">
                    ...
                    <select id="progression" name="progression" class="mt-1 block w-full"
                        x-model="formData.progression">
        ...
        <div x-show="currentStep === 2" x-transition>
            <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-2">
                    <label class="flex items-start gap-2" title="{{ __('courses.show_index') }}">
                        <input type="hidden" name="show_index" value="false">
                        <input type="checkbox" name="show_index" value="true"
                            {{ old('show_index', $course->show_index ?? '') === 1 ? 'checked' : '' }}
                            class="mt-1 rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500">
                        <span class="ml-2 text-sm text-gray-600">
                            {{ __('courses.show_index') }}
                        </span>
                    </label>
                    @if ($errors->has('show_index'))
                        <x-input-error for="show_index" :messages="$errors->get('show_index')" class="mt-2" />
                    @endif
                </div>
        ...
        <div x-show="currentStep === 3" x-transition>
            <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <x-input-error for="capacity" :messages="$errors->get('capacity')" class="mt-2" />
                </div>

                <div class="col-span-6 sm:col-span-3">
                    <x-label for="days_to_complete" value="{{ __('courses.days_to_complete') }}" />
                    <x-input id="days_to_complete" name="days_to_complete" type="number" min="1"
                        class="mt-1 block w-full" x-model="formData.days_to_complete" />
                    <x-input-error for="days_to_complete" :messages="$errors->get('days_to_complete')" class="mt-2" />
                </div>
                ...
                <div class="col-span-3">
                    ...
                    <x-image-input name="thumbnail" x-on:change="formData.thumbnail = $event.detail" />
                ...
                <div class="col-span-3">
                    ...
                    <x-image-input name="cover" x-on:change="formData.cover = $event.detail" />
